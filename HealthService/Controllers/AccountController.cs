...
namespace HealthService.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            HealthServiceContext db = new HealthServiceContext();
            User user1 = db.Users.Where(r => r.Username == loginView.UserName).FirstOrDefault();
            if(user1 != null)
            {
                if(user1.IsActive == false)
                {
                    ModelState.AddModelError("", "Something Wrong : This account isn't active.");
